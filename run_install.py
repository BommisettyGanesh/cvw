...
with open(log_path, "w") as log_file:
    log_file.write("Starting Wally toolchain installation...\n")
    log_file.flush()
    ...
    cmd = [os.path.join(wally_dir, "bin/wally-tool-chain-install.sh"), "--clean"]
    ...
    print(f"Toolchain installer launched with PID {proc.pid}")
